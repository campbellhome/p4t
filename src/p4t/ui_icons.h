...
#define COLOR_FILE_LOCAL_ACTION ImColor(192, 64, 64)
#define COLOR_FILE_REMOTE_ACTION ImColor(69, 96, 192)
#define COLOR_FILE_SUBMITTED_ACTION ImColor(255, 255, 255)
#define COLOR_FILE_SHELVED_ACTION ImColor(192, 192, 192)
